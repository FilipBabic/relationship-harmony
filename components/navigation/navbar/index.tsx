  ...
  return (
    <nav className="fixed z-50 flex w-full items-center justify-between gap-5 bg-white p-4 font-bold shadow-md sm:px-12">
      <Link href="/" className="flex items-center gap-1">
        ...
        <p className="font-playfair text-2xl font-extrabold text-[#394155] max-sm:hidden">
          Relationship<span className="text-xl font-bold text-warm-pink">harmony</span>
        </p>
      </Link>
      <Link href="/about-tests" className="font-bold text-[#394155] hover:text-warm-pink">
        How it Work&apos;s?
      </Link>
      <div className="flex items-center gap-1">
        <Button asChild className="bg-[#394155] hover:bg-[#5A6A7A]">
          <Link href="/quiz">
            <ClipboardCheck />
            Take test
          </Link>
